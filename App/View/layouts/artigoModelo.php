...
<head>
    ...
    <title>blogmasters:Titulo principal do Artigo</title>
</head>
<body>
    <main>
        <section>
            <article>
                <header>    
                <h3> TITULO PRINCIPAL DO ARTIGO </h3>
                ...
                <footer>  
                <p class="article-copy"> Por {Autor} ,
                    <time datetime="2020-03-20 19:14"> {Data da Postagem}</time></p>
                </footer>
            </article>
        </section>
    </main>
